...
public class _01_String1 {
    public static void main(String[] args){
        ...
        System.out.println(s.indexOf("and")); // 처음 일치하는 정보 12
        System.out.println(s.lastIndexOf("and")); // 마지막으로 일치하는 정보 23
        System.out.println(s.startsWith("I")); // 이 문자열로 시작하면 true, 아니면 false
